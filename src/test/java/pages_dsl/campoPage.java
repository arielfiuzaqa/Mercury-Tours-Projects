...
public class campoPage {
    ...
    public void irSite() { dsl.abrirChrome(); }
    ...
    public void execucaoCompletaLogin() { dsl.vouParaSite("https://demo.guru99.com/test/newtours/");
            dsl.preencherLoginESenha("zezim01@gmail.com", "*8585916#AF669"); dsl.confirmarLogin(); }
    public void finalizar() { dsl.fecharBrowser(); }
}
